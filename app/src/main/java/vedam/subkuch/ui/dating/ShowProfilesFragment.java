...
import vedam.subkuch.ui.dating.models.LikeDislike;
import vedam.subkuch.ui.dating.models.LikeDislikeResponse;
import vedam.subkuch.ui.dating.preference.PreferenceFragment;
...
public class ShowProfilesFragment extends BaseFragment implements CardStackListener {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        menu.clear();
        inflater.inflate(R.menu.dating, menu);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_preferences:
                addFragmentWithAnimation(R.id.content_frame, PreferenceFragment.newInstance(), null, true);
                return true;
            case R.id.action_matched_profiles:
                addFragmentWithAnimation(R.id.content_frame, MatchedProfileFragment.newInstance(), null, true);
                return true;
