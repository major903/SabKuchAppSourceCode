...
public class ProfileRequest implements Parcelable {
    ...
    protected ProfileRequest(Parcel in) {
    ...
    public static final Creator<ProfileRequest> CREATOR = new Creator<ProfileRequest>() {
        @Override
        public ProfileRequest createFromParcel(Parcel in) {
            return new ProfileRequest(in);
        }

        @Override
        public ProfileRequest[] newArray(int size) {
            return new ProfileRequest[size];
        }
    };
