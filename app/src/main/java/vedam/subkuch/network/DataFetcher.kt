...
object DataFetcher {
    ...
    fun <T> getCategories(
        ...
        val url = String.format("%s/Directory/GetCategories", NetworkConstants.END_POINT2)
        HelperVolley.callGetApi(context, url, null, updateSuccessListener, repClass, errorListener)
    }
    ...
    fun <T> getSubCategories(
        ...
        val url = String.format(
            "%s/Directory/GetSubCategories?CategoryId=%s",
            NetworkConstants.END_POINT2,
            categoryId
        )
        HelperVolley.callGetApi(context, url, null, updateSuccessListener, repClass, errorListener)
    ...
    fun <T> getPublicUtilities(
        ...
        val url = String.format(
            Locale.US,
            "%s/api/PublicUtility/GetPublicUtilities?SubCategoryId=%s&UserId=%s&PageIndex=%d&PageSize=%d",
            NetworkConstants.END_POINT2,
            subCategoryId,
            userId,
            pageIndex,
    ...
    fun <T> addBusiness(
        ...
        val url = String.format("%s/Directory/AddBusiness", NetworkConstants.END_POINT2)
        HelperVolley.callApiWithBody(
            context,
            url,
            null,
